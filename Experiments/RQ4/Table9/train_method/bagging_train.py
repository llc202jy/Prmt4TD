...
class BaggingTrainer:
    def __init__(self, train_df, data_type):
        ...
        self.model_file = f'{folder}/results/Bagging/{data_type}/model.joblib'
        self.result_file = f'{folder}/results/Bagging/{data_type}/results.txt'
        self.p_value_file = f'{folder}/results/Bagging/{data_type}/p_value.json'
...
if __name__ == '__main__':
    ...
    trainer = BaggingTrainer(train_df, 'TacticData')
    # 验证平衡数据集的20%
